...
print("Data setelah diurutkan (Descending):", nilai_ujian)
nilai_beasiswa = nilai_ujian[0:3]
print("Tiga nilai tertinggi (Penerima Beasiswa):", nilai_beasiswa)

nilai_lulus = []
for nilai in nilai_ujian:
  if nilai >= 60:
      nilai_lulus.append(nilai)
print("Daftar nilai yag lulus:", nilai_lulus)
